...
impl EffectType {
    pub fn type_name(&self) -> &'static str {
        match self {
            Self::SpeedUp(_) => "Speed Stat Up",
            Self::StaminaUp(_) => "Stamina Stat Up",
            Self::PowerUp(_) => "Power Stat Up",
            Self::GutsUp(_) => "Guts Stat Up",
            Self::WitUp(_) => "Wit Stat Up",
            Self::AllStatsUp(_) => "All Stats Up",
            Self::CurrentSpeedUp(_) => "Increase Current Speed",
            Self::CurrentSpeedDown(_) => "Decrease Current Speed",
            Self::TargetSpeedUp(_) => "Increase Target Speed",
            Self::ZenkaiSpurtAcceleration(_) => "Zenkai Spurt Acceleration",
            Self::AccelerationUp(_) => "Increase Acceleration",
            Self::StaminaRecovery(_) => "Stamina Recovery",
            Self::FieldOfViewUp(_) => "Increase Field of View",
            Self::LaneChangeSpeed(_) => "Increase Lane Movement Speed",
            ...
            Self::RushTimeIncrease(_) => "Increase Rush Time",
            Self::RushChanceDecrease(_) => "Decrease Rush Chance",
